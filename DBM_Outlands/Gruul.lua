...
function Gruul:OnCombatStart(delay)
	self.Grows = 0;	
	self:ScheduleSelf(35 - delay, "SilenceSoon");
	self:StartStatusBarTimer(40 - delay, "Silence", "Interface\\Icons\\Spell_Holy_ImprovedResistanceAuras");	
...
function Gruul:OnEvent(event, arg1)
	...
	elseif event == "SPELL_AURA_APPLIED" then
		...
		elseif arg1.spellId == 36297 then
			...
			self:ScheduleSelf(45, "SilenceSoon");
			self:StartStatusBarTimer(52, "Silence", "Interface\\Icons\\Spell_Holy_ImprovedResistanceAuras");
		end
    ...
    elseif event == "Slam" then
        ...
        self:EndStatusBarTimer("Ground Slam");
        self:StartStatusBarTimer(75, "Ground Slam", "Interface\\Icons\\Spell_Nature_ThunderClap");
	end
end
