...
function Leotheras:OnCombatStart(delay)
	...
	self:StartStatusBarTimer(17, "Next Whirlwind", "Interface\\Icons\\Ability_Whirlwind");
...
--			self:ScheduleSelf(10, "DemonsSoon");
		...
		elseif arg1 == DBM_LEO_YELL_SPLIT then			
		...
		elseif arg1 == DBM_LEO_YELL_SHADOW then
			...
			self:StartStatusBarTimer(24, "Next Whirlwind", "Interface\\Icons\\Ability_Whirlwind");
...
function Leotheras:OnSync(msg)
	if msg == "GainWW" then
		...
		self:EndStatusBarTimer("Next Whirlwind");
		self:StartStatusBarTimer(10, "Whirlwind", "Interface\\Icons\\Ability_Whirlwind");
		self:ScheduleMethod(10, "SendSync", "FadeWW");
	...
	elseif msg == "FadeWW" and self.Phase ~= "demon" then
		...
		if not self:GetStatusBarTimerTimeLeft("Demon Form") or self:GetStatusBarTimerTimeLeft("Demon Form") > 18 then
			self:StartStatusBarTimer(23, "Next Whirlwind", "Interface\\Icons\\Ability_Whirlwind");
			self:ScheduleSelf(18, "WhirlWarn");
		end
